...
class ValueAtRisk:
    def __init__(self, array, alpha, axis: int=0, portfolio_mean=None, portfolio_std_dev=None) -> None:
        """
        ...
        """
        self.portfolio_mean = portfolio_mean
        self.portfolio_std_dev = portfolio_std_dev
    ...
    def parametrical_var(self, plot: bool=False, bins: int=50) -> float:
        ...
        """
        mean = self.portfolio_mean #if self.portfolio_mean else Statistics(array=self.array, axis=self.axis).mean()
        std = self.portfolio_std_dev #if self.portfolio_std_dev else Statistics(array=self.array, axis=self.axis).std()
...
class PickandsEstimator:
    def __init__(self, array, alpha, k: int=5, axis: int=0) -> None:
        """
...
class BackTesting:
    ...
    def normal_test(self, threshold: float, alpha) -> dict:
        """
    ...
    def kupiec_test(self, threshold: float, alpha) -> dict:
        """
    ...
    def christoffersen_test(self, threshold: float, alpha) -> dict:
        """
    ...
    def kupiec_christoffersen_test(self, threshold: float, alpha) -> dict:
        """
    ...
    def var_diameter(self, var: list, alpha) -> dict:
        """
